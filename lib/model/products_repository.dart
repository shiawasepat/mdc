  ...
  static List<Product> loadProducts(Category category) {
    const allProducts = <Product>[
      ...
      Product(
        ...
        id: 2,
        isFeatured: false,
        name: 'Kana Arima Chibi Keychain',
        price: 35,
      ),
      Product(
        ...
        id: 3,
        isFeatured: true,
        name: 'Kana Arima Baking Soda Tee',
        price: 98,
      ),
      Product(
        category: Category.figurine,
        id: 4,
        isFeatured: false,
        name: 'Kana Arima Acrylic Stand Figure',
        price: 34,
      ),
      // Product(
      ...
      Product(
        ...
        id: 7,
        isFeatured: true,
        name: 'Tsurugi Acrylic Stand Figure',
        price: 40,
      ),
      // Product(
      //   category: Category.accessories,
